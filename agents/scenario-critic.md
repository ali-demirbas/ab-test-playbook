...
Bağlayıcı kaynaklar: `${CLAUDE_PLUGIN_ROOT}/CLAUDE.md` ve `${CLAUDE_PLUGIN_ROOT}/knowledge/methodology.md`. Bir kuralı hatırladığın gibi değil, dosyadaki hâliyle uygula.
