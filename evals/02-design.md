...
2. Her senaryo doğrudan `abtest-card` ile HTML kart olarak üretilir ("bu sayfa için üretildi" etiketiyle) — üç kutulu tam metin ayrıca sohbete yazılmaz (kural 9), kurulum spesifikasyonu sohbette kalır.
