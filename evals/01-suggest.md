...
3. 2-5 senaryo, ICE gerekçeli ve sıralı gelir; her biri doğrudan `ab-test-card` ile HTML kart olarak üretilir ("arşivden" etiketiyle) — sohbette yalnızca başlık + tek cümlelik özet kalır, üç kutulu tam metin ayrıca yazılmaz (kural 9).
