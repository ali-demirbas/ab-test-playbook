...
6. Marka kılavuzu sorusu bu oturumda sorulmadıysa önce onu sor (kural 12). Ardından her seçilen senaryoyu (2-5 arası) doğrudan `abtest-card` ile HTML'e çevir (CLAUDE.md kural 9) — üç kutunun tam içeriği yalnızca kartta bulunur, sohbete ayrıca metin olarak yazılmaz.
