# ab-test-playbook — A/B testing & CRO playbook with 197 experiment scenarios
...
![Scenarios](https://img.shields.io/badge/scenarios-197-blue)
...
Built from an archive of A/B test scenarios and hypothesis-generation patterns used in real e-commerce, mobile app and SaaS growth work — 197 scenarios, methodology and text content, not a shipped visual deck. Covers experiment design, test prioritization (ICE scoring), statistical significance and sample-size math, guardrail metrics, and checkout/product-page/pricing optimization. Every scenario follows the same three-box discipline:
...
|---|---|
| Test ideas come from memory or whatever feels right today | Ranked by ICE from a 197-scenario archive, or generated with a stated mechanism — "more eye-catching" isn't an accepted reason |
